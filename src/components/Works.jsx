  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          We believe that the future of the crypto industry lies in innovation, and we are committed to leading the way. Our goal is to provide our community with powerful and easy-to-use tools that leverage the power of AI to help navigate daily life. Whether you are a seasoned investor or just into tech, our platform is designed to meet your needs.
          At the heart of our business is a commitment to excellence. We strive to be the best in everything we do, from our development process to our customer support. Our team is comprised of experts in their fields, with extensive experience in AI, blockchain, and XR software development. Together, we work tirelessly to create a platform that delivers unparalleled value to our users.
